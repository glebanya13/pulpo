...
/// Страны и валюты в нужном порядке (повторы кода — разные страны).
const appCurrencies = <AppCurrency>[
  ...
  AppCurrency(country: 'El Salvador', code: 'USD', symbol: r'$', flag: '🇸🇻'),
  ...
  AppCurrency(country: 'Puerto Rico', code: 'USD', symbol: r'$', flag: '🇵🇷'),
  AppCurrency(
...
/// Уникальные коды, в порядке первого появления в списке.
