...
class Tr {
  ...
  static const Map<String, Map<String, String>> _dict = {
    ...
    'en': {
      ...
      'get_started': 'Почати',
      'try_demo': 'Спробуйте на прикладі',
      ...
      'setup_subtitle': 'Увійдіть у свій акаунт або продовжте як гість. Ваше ім \'я та валюту буде збережено на вашому пристрої.',
      ...
      'enter_note': 'Введіть примітку',
      'transaction_singular': 'Трансакція',
      'analytics_subtitle': 'Куди йдуть гроші',
      'tab_overview': 'Загальна частина',
      ...
      'no_expenses_period': 'Відсутність витрат · {}',
      'income_vs_expenses': 'Доходи vs витрати · {}',
      'expense_this_month': 'Витрати за цей місяць',
      'expense_today': 'Споживання сьогодні',
      'vs_prev_month': 'проти минулого місяця',
      'vs_yesterday': 'у порівнянні з вчорашнім днем',
      'cash_flow': 'Грошовий потік',
      'income_upper': 'ПРИХІД',
      'expense_upper': 'РОЗХІД',
      'net_upper': 'Чисто',
      'top_income_sources': 'Найпопулярніші джерела доходу',
      'top_expenses': 'Найпопулярніші витрати',
      'my_accounts': 'Мої рахунки',
      'my_account': 'Мій аккаунт',
      'net_worth': 'ЧИСТИЙ КАПІТАЛ',
      'in_realtime': '↑ в режимі реального часу',
      'history_12_weeks': '12 тижнів',
      'offline_first_tag': 'Monedero · в автономному режимі',
      'tx_id': 'Ідентифікатор: txn_{}',
      'bank_accounts': 'Банківські рахунки',
      'cash_wallets': 'Готівка та гаманці',
      'add_account': 'Додати рахунок',
      'new_account': 'Діалогове вікно створення рахунка',
      ...
      'cat_food': 'Їжа',
      'cat_transport': 'Транспорт',
      'cat_housing': 'Проживання',
      'cat_health': 'Здоров\'я',
      'cat_entertainment': 'Вечірки',
      'cat_clothing': 'Одяг',
      ...
      'cat_investments': 'Інвестиційний кредит',
      ...
      'account_type_crypto': 'Крипта',
      'account_type_investment': 'Інвестиційний кредит',
      'account_type_loan': 'Позика/кредит',
      'tx_not_found': 'Транзакцію не знайдено',
      'tx_location': 'Місце',
      'tx_duplicate': 'Здублювати',
      'income_lower': 'ДОХОД',
      'expense_lower': 'видаток',
      'transfer_lower': 'переклад',
      'transfer_from': 'Де?',
      'transfer_to': 'Куди',
      'transfer_sending': 'Надсилання',
      'transfer_recipient_gets': 'Одержувач отримає',
      ...
      'active_tab': 'Активні',
      'paused_tab': 'Пауза',
      'paused_plural': 'Відтворення диска призупинено',
      'rules_empty_title': 'Немає правил',
      'rules_empty_desc': 'Автоматизуйте періодичні платежі: орендну плату, рахунки, заробітну плату.',
      'new_rule': 'Нове правило',
      'edit_rule': 'Редагувати правило',
      'delete_rule_title': 'Видалити правило?',
      'frequency_label': 'Частота вибірки',
      'freq_daily': 'Щодня',
      'freq_weekly': 'Щотижня',
      'next_run_prefix': 'Далі:',
      'by_categories_month_prefix': 'За категоріями.',
      'expenses_by_categories_month_prefix': 'Витрати за категоріями ·',
      'cash_flow_month_prefix': 'Грошова активність',
      ...
      'account_not_found': 'Рахунок не знайдений',
      ...
      'local_backups_upper': 'ЛОКАЛЬНЕ РЕЗЕРВНЕ КОПІЮВАННЯ',
      ...
      'auto_cloud_backup': 'Резервне копіювання в',
      ...
      'cloud_restore_keep_local': 'Залишити місцевий',
      'budget_categories': 'Категорії',
      'budget_categories_all': 'Всі',
      ...
      'shared_budget_title': 'Загальний бюджет',
      'shared_budget_subtitle': 'Відстежуйте та синхронізуйте витрати з партнером',
      'shared_budget_create': 'Створити парний бюджет',
      ...
      'shared_budget_even': 'Ви в розрахунку ✌️',
      'shared_budget_sync': 'Синхронізувати щомісячні витрати',
      'shared_budget_leave': 'Зняти із загального бюджету',
      'shared_budget_leave_title': 'Зняти з загального бюджету?',
      ...
      'widget_month_expense': 'Видаток',
      'smart_budget_title': 'Бюджет',
      'smart_budget_body': '{} майже вичерпано ({})',
      'select_short': 'Вибрати',
      'enter_note_hint': 'Введіть примітку...',
      'backups_short': 'Резервні копії',
      'transfer_between': 'Внутрішній переклад',
      'transfer_between_title': 'Переказ між рахунками',
      'transfer_between_short': 'Внутрішній переклад',
      'transfer_between_tab': 'Внутрішній переклад',
      'transfer_external': 'Зовнішній переказ',
      'transfer_external_tab': 'Зовнішній переказ',
      'transfer_between_hint': 'Переказ між обліковими записами. Це не є доходом або витратами.',
      'transfer_external_hint': 'Гроші виходять, вважаються витратами.',
      'month_balance': 'Щомісячний баланс',
      'month_net': 'Загалом',
      'sign_in': 'Увійти',
      'sign_in_apple': 'Продовжити з Apple',
      'sign_in_google': 'Продовжити за допомогою Google',
      ...
      'delete_cloud_account_failed': 'Не вдалося видалити обліковий запис',
      'auth_failed': 'Вхід зазнав невдачі.',
      ...
      'auth_user_disabled': 'Обліковий запис деактивовано',
      ...
      'cloud_restore_ok': 'Дані, відновлені з хмари',
      ...
      'sync_devices': 'Синхронізація пристрою',
      'security': 'Безпека',
      'pin_code': 'Особистий ідентифікаційний код:',
      'pin_code_hint': 'Необов \'язково: якщо ідентифікатор особи не працює',
      'use_biometrics': 'Біометричний замок',
      'biometric_lock_hint': 'Запитайте ідентифікатор особи або відбиток пальця під час входу',
      ...
      'pin_mismatch': 'PIN-код не збігається',
      'pin_wrong': 'Недійсний PIN-код',
      'unlock': 'Розблокувати',
      'unlock_biometric_hint': 'Використовуйте ідентифікатор особи або відбиток пальця, щоб продовжити',
      'export_csv': 'Експорт в CSV',
      'export_excel': 'Експорт в Excel',
      'export_pdf': 'Експорт в PDF',
      'export_period': 'Період експорту',
      'period_this_month': 'За місяць:',
      'period_last_month': 'Попереднього місяця',
      'period_3m': '3 місяці',
      'period_6m': '6 місяців',
      'period_this_year': 'За рік:',
      'period_last_year': 'Попередній рік',
      'period_custom': 'Ваш період',
      ...
      'import_no_rows': 'У файлі не знайдено жодних транзакцій',
      'data_load_db_error': 'Не вдалося прочитати локальну базу даних',
      'data_load_network_error': 'Помилка завантаження даних',
      'data_load_generic_error': 'Помилка під час завантаження:% 1.',
      'firebase_offline_banner': 'Немає з \'єднання з Firebase: логін, хмара та ШІ недоступні',
      'data_init_failed_banner': 'Помилка локальних даних, перезапустіть програму',
      'account_section': 'Аккаунт',
      'pro_title': 'Monedero Pro',
      'pro_subtitle': 'Немає обмежень щодо облікових записів, цілей, звітів, AI (перевірок та голосу), імпорту та хмарних копій.',
      ...
      'pro_store_empty': 'Наразі ціни недоступні. Перевірте Інтернет і повторіть спробу.',
      'pro_debug_unlock': 'Відкрити Pro (зневаджування)',
      'import_csv': 'Імпортувати CSV-файл',
      'import_csv_hint': 'Імпортувати CSV-файл Monedero або банківську виписку з датою та сумою.',
      'import_pick_file': 'Вибрати файл',
      'import_preview': '{n} транзакції готові · {s} рядків пропущено',
      'import_confirm': 'Импортировать',
      'import_failed': 'Не вдалося імпортувати файл:% 1',
      'import_done': 'Імпортовано {} транзакцій',
      'reminders_page_hint': 'Налаштуйте, коли нагадувати вам про витрати. Інтелектуальні сповіщення — лише в Pro.',
      ...
      'smart_debt_title': '& Сплата',
      'smart_debt_body': 'До сплати сьогодні: {}',
      'smart_sub_title': 'Передплата',
      'smart_sub_body': 'З вас найближчим часом стягуватиметься {}',
      'smart_goal_title': 'Мета',
      'smart_goal_body': 'Будь ласка, перевірте ціль: {}',
      'pro_gate_accounts': 'У безкоштовній версії доступно до 3 облікових записів.\nПерейдіть на Pro, щоб додати необмежену кількість облікових записів.',
      ...
      'pro_gate_ai': 'Асистент ШІ (голос, чеки, чат) доступний у Pro.\nУвійдіть у свій обліковий запис і перейдіть на Pro.',
      'ai_recognize_receipt': 'Розпізнавання за допомогою ШІ',
      ...
      'ai_voice_saved': '{} транзакцій збережено',
      'ai_listening': 'Слухаю…',
      'ai_confirm_transcript': 'Використовувати цей текст?',
      'ai_use_transcript': 'Використання',
      'ai_category_suggest': 'ШІ пропонує: {}',
      'ai_apply_category': 'Застосувати',
      'ai_insight_title': 'AI Insight',
      'ai_insight_generate': 'Генерувати',
      'ai_insight_hint': 'Короткий текст за підсумками періоду. Необроблені операції не надсилаються.',
      'ai_chat_title': 'Асистент',
      'ai_chat_hint': 'Голосові повідомлення, фотографії або текстові повідомлення — Я запишу витрати та доходи.',
      'ai_chat_placeholder': 'Повідомлення',
      'ai_chat_welcome': 'Добрий день! Я ваш фінансовий помічник. Я можу записати витрати або доходи — напишіть «Кава 60» або «Зарплата 25 000». Ви можете надіслати фотографію квитанції, поговорити голосом або запитати інформацію в додатку.',
      'ai_assistant_eyebrow': 'ИИ.',
      'ai_recording': 'Запис...',
      'ai_chat_receipt_sent': 'Чек',
      'ai_receipt_unreadable': 'Не вдалося прочитати квитанцію. Спробуйте іншу фотографію або надішліть текстове повідомлення.',
      ...
      'ai_invalid_response': 'ШІ повернув несподіваний формат. Спробуйте ще раз.',
      'ai_speech_unavailable': 'Мікрофон недоступний. Будь ласка, введіть текстовий потік або спробуйте на справжньому iPhone.',
      'ai_api_not_enabled': 'Увімкніть логіку AI Gemini / Firebase у консолі Firebase.',
      'ai_permission_denied': 'Firebase відхилила AI (перевірка додатків). У режимі зневаджування: скопіюйте маркер із журналів та збережіть у Firebase → App Check → Керування маркерами зневаджування.',
