...
class Tr {
  ...
  static const Map<String, Map<String, String>> _dict = {
    ...
    'uk': {
      ...
      'cancel': 'Скасувати',
      'delete': 'Видалити',
      'delete_tx_title': 'Видалиті транзакцію?',
      'delete_tx_body': 'Це действие нельзя скасувить.',
      'edit': 'Змінити',
      'add': 'Додати',
      'select': 'Выбрать',
      'search': 'Пошук',
      ...
      'greeting_afternoon': 'Добрый день 👋',
      'greeting_evening': 'Добрый вечер 👋',
      'greeting_night': 'Доброй ночі 🌙',
      'total_balance': 'ОБЩИЙ БАЛАНС',
      'recent_transactions': 'Недавние транзакціи',
      'see_all': 'Усі →',
      'empty_transactions': 'Покі порожньо. Натисніть + щпро додавить.',
      'calendar': 'Календарь',
      'view_history': 'История →',
      'no_tx_this_day': 'Транзакцій за цей день нет',
      'weekday_mon': 'Пн',
      'weekday_tue': 'Вт',
      'weekday_wed': 'Ср',
      'weekday_thu': 'Чт',
      ...
      'edit_budget': 'Зміниті бюджет',
      'delete_budget_title': 'Видалиті бюджет?',
      'budget_name': 'Название бюджета',
      'recurring_ops': 'Регулярные операції',
      'goals': 'Цілі',
      'new_goal': 'Нова ціль',
      'edit_goal': 'Зміниті ціль',
      'goal_name': 'Название',
      'goal_target': 'Сума цели',
      'goal_saved': 'Накоплено',
      'goals_empty_title': 'Ні цілей',
      'goals_empty_desc': 'Создай ціль накопления і следі за прогрессом.',
      'add_to_goal': 'Пополнить',
      'subscriptions': 'Підписки',
      'debts': 'Борги',
      'all_settings': 'Усі налаштуванни',
      'accounts_count_label': 'рахунків',
      'transactions_count': 'транзакцій',
      'month_label': 'цей місяц',
      'base_currency_label': 'Основная валюта',
      ...
      'theme_dark_hint': 'Увімкнить ночную тему',
      'daily_reminder': 'Автоматичние ежедневные нагадувания',
      'daily_reminder_at': 'Нагадувание у {} записать дохіды і витраты',
      'daily_reminder_off_hint': 'Увімкні переключатель і вибері время',
      'daily_reminder_time': 'Время',
      'daily_reminder_cta': 'Сповіщення',
      'daily_reminder_cta_on': 'Каждый день у {}',
      'daily_reminder_cta_off': 'Настроить расписание',
      'daily_reminder_title': 'Ежедневное нагадувание ⏰',
      'daily_reminder_body': 'Запиші дохіды і витраты за сьогодні — тадо проще держать фінансы под контролем.',
      'reminder_permission_denied': 'Дозволі сповіщения у налаштуваннах системы, щпро отриманать нагадувание.',
      'theme_light': 'Світлая',
      'theme_dark': 'Темная',
      'theme_system': 'Ядо у системе',
      'base_currency': 'Базовая валюта',
      'for_totals_reports': 'Для загалих разому і звітов',
      'shown_in_app': 'Отображаеться у додаткии',
      'name': 'Імʼя',
      'data_backups': 'Такнные і бэкапы',
      'export_data': 'Експорт даних',
      'json_backup': 'JSON бэкап',
      'import_backup': 'Імпорт з бэкапа',
      'about': 'Про додаток',
      'version': 'Версія',
      'privacy_policy': 'Политика конфіденційности',
      'terms_of_use': 'Умові использования',
      'contact_support': 'Підтримка',
      'could_not_open_link': 'Не вдалося відкрить ссылку',
      'enter_name': 'Введіть имя',
      'your_name': 'Ваше имя',
      'how_to_call': 'Ядо до вам обращаться?',
      'take_control_of': 'Возьмите под\nконтроль',
      'finance': 'фінансы',
      'onboarding_subtitle': 'Учёт витратов, бюджеты і цели. Всё працює офлайн.',
      'get_started': 'Начать →',
      'try_demo': 'Відкрить без акаунта',
      'continue_without_account': 'Продовжиті без входа',
      'please_enter_name': 'Пожалуйста, введіть имя',
      'setup_title': 'Немного о вас',
      'setup_subtitle': 'Заповните дані — це збережиться лише на вашем пристрое',
      'initial_balance': 'Начальный баланс',
      'currency': 'Валюта',
      ...
      'receipt_gallery': 'Галерея',
      'amount': 'Сума',
      'empty_transactions_list': 'Транзакцій нет.',
      'enter_note': 'Введіть заметку',
      'transaction_singular': 'Транзакція',
      'analytics_subtitle': 'Куда уходят гроші',
      'tab_overview': 'Загалее',
      'tab_categories': 'Категорії',
      'tab_trends': 'Тренды',
      'tab_flows': 'Потіки',
      'expenses_6_months': 'Витратаы · {}',
      'by_categories': 'По категоріям',
      'total_word': 'усього',
      'expenses_by_categories': 'Витратаы по категоріям',
      'no_expenses_this_month': 'Ні витратоу за цей місяц',
      'no_expenses_period': 'Ні витратоу · {}',
      'income_vs_expenses': 'Дохіды vs Витратаы · {}',
      'expense_this_month': 'Витрата у цьому місяце',
      'expense_today': 'Витрата сьогодні',
      'vs_prev_month': 'vs прошлый місяц',
      'vs_yesterday': 'vs вчора',
      'cash_flow': 'Денежный потік',
      'income_upper': 'ПРИХОД',
      'expense_upper': 'РАСХОД',
      'net_upper': 'ЧИСТО',
      'top_income_sources': 'Топ источникоу дохіда',
      'top_expenses': 'Топ витратов',
      'my_accounts': 'Моі рахунки',
      'my_account': 'Мой акаунт',
      'net_worth': 'ЧИСТЫЙ КАПИТАЛ',
      'in_realtime': '↑ у реальном времени',
      'history_12_weeks': '12 тижнь',
      'offline_first_tag': 'Monedero · офлайн',
      'tx_id': 'ID: txn_{}',
      'bank_accounts': 'Банковские рахунки',
      'cash_wallets': 'Готівка і кошельки',
      'add_account': 'Додаті рахунок',
      'new_account': 'Новий рахунок',
      'edit_account': 'Зміниті рахунок',
      'delete_account_title': 'Видалиті рахунок?',
      'delete_account_body': 'Усі транзакціі по цему рахуноку будут видалены. Це действие нельзя скасувить.',
      'account_name': 'Название',
      'include_in_total': 'Учитывать у загалем балансе',
      'reset_all_data': 'Скиданнить дані на пристрое',
      'reset_all_data_subtitle': 'Видалит рахункі і операциі на цьому телефоне. Хмарный акаунт не видаляеться.',
      'reset_all_data_title': 'Видалиті дані с пристроа?',
      'reset_all_data_body': 'На цем телефоне будут видалены рахунки, транзакціи, категоріи, бюджеты, борги, целі і підписки. Налаштування і хмарный акаунт остануться. Це нельзя скасувить.',
      'reset_success': 'Такнные видалены',
      'account_type': 'Тип',
      'filter_all': 'Усі',
      ...
      'account_type_card': 'Картка',
      'account_type_bank': 'Банковский рахунок',
      'account_type_ewallet': 'Эл. кошелёк',
      'account_type_crypto': 'Крипта',
      'account_type_investment': 'Інвестиції',
      'account_type_loan': 'Позик/Кредит',
      'tx_not_found': 'Транзакція не знайдена',
      'tx_location': 'Место',
      'tx_duplicate': 'Дублировать',
      'income_lower': 'дохід',
      'expense_lower': 'витрат',
      'transfer_lower': 'переказ',
      'transfer_from': 'Откуда',
      'transfer_to': 'Куда',
      'transfer_sending': 'Надсилляете',
      'transfer_recipient_gets': 'Отриманатель отриманит',
      'exchange_rate': 'Курс обмена',
      'rate_prefix': 'Курс: 1 ',
      'fee': 'Комиссия',
      'confirm': 'Підтвердить',
      'select_account': 'Выбрать рахунок',
      'balance_prefix': 'Баланс: ',
      'new_category': 'Нова категорія',
      'edit_category': 'Зміниті категорію',
      'delete_category_title': 'Видалиті категорію?',
      'color_label': 'Колір',
      'icon_label': 'Іконка',
      'title_label': 'Название',
      'i_owe': 'Я должен',
      'owed_to_me': 'Мне должны',
      'new_debt': 'Новий борг',
      'edit_debt': 'Зміниті борг',
      'delete_debt_title': 'Видалиті борг?',
      'to_from_whom': 'Кому / від кого',
      'without_due_date': 'Без срока',
      'due_date_label': 'Сродо возврата',
      'due_prefix': 'Срок: ',
      'overdue': 'просрочен',
      'day_short': 'дн',
      'paid_of_template': 'Погашено {p} з {t}',
      'repayment': 'Возврат',
      'debts_empty_title': 'Боргоу нет',
      'debts_empty_desc': 'Додавьте борг, щпро весті учёт позикоу і возвратов.',
      'persons_word': 'человек',
      'active_plural': 'активных',
      'per_month': 'У місяц',
      'per_year': 'У год',
      'subs_empty_title': 'Подписодо нет',
      'subs_empty_desc': 'Додавьте Netflix, Spotify і другие сервисы,\nщпро видеть загалие витраты.',
      'next_payment_label': 'Ближайший платёж',
      'all_subscriptions': 'Усі підписки',
      'new_subscription': 'Нова підписка',
      'edit_subscription': 'Зміниті підписку',
      'delete_sub_title': 'Видалиті підписку?',
      'service_name': 'Название сервиса',
      'periodicity': 'Періодичность',
      'monthly_label': 'Щомісячно',
      'yearly_label': 'Щорічно',
      'next_payment_prefix': 'Наступний платёж: ',
      'in_days_short': 'через {n} дн.',
      'active_tab': 'Активные',
      'paused_tab': 'Пауза',
      'paused_plural': 'на паузе',
      'rules_empty_title': 'Правил нет',
      'rules_empty_desc': 'Автоматизируйте регулярные списания: оренду, рахунки, зарплату.',
      'new_rule': 'Нове правило',
      'edit_rule': 'Зміниті правило',
      'delete_rule_title': 'Видалиті правило?',
      'frequency_label': 'Частота',
      'freq_daily': 'Ежедневно',
      'freq_weekly': 'Щотижнево',
      'next_run_prefix': 'Таклі: ',
      'by_categories_month_prefix': 'По категоріям · ',
      'expenses_by_categories_month_prefix': 'Витратаы по категоріям · ',
      'cash_flow_month_prefix': 'Денежный потідо · ',
      'search_currency': 'Пошудо валюты',
      'popular_upper': 'ПОПУЛЯРНЫЕ',
      'crypto_upper': 'КРИПТО',
      'error_title': 'Щось пошло не так',
      'add_account_first': 'Сначала додавьте рахунок',
      'account_not_found': 'Рахунодо не знайден',
      'backup_created': 'Бэкап створен',
      'auto_backup': 'Автоматични',
      'auto_backup_desc': 'Ежедневный локальный бэкап',
      'create_now': 'Створить зараз',
      'local_backups_upper': 'ЛОКАЛЬНЫЕ БЭКАПЫ',
      'no_backups_title': 'Бэкапоу нет',
      'no_backups_desc': 'Создайте перший бэкап,\nщпро збережить дані.',
      'empty_budgets_title': 'Ещё немає бюджетов.',
      'spent_this_month': 'Потрачено у цьому місяце',
      'out_of_budget_template': 'з {} бюджета',
      'credit_limit_prefix': 'Ліміт: ',
      'credit_limit': 'Кредитный ліміт',
      'credit_limit_hint': 'Необов\'язково',
      'auto_cloud_backup': 'Хмарный бэкап',
      'auto_cloud_backup_desc': 'Ежедневная автозавантаження',
      'last_sync_prefix': 'Останняя sync: ',
      'never_synced': 'Ещё не синхронизировано',
      'cloud_restore_title': 'Відновлить дані?',
      'cloud_restore_body': 'Можно заменить локальные дані хмарной копіей або завантажить локальные дані у хмаро.',
      'cloud_restore_use_cloud': 'Из хмара',
      'cloud_restore_keep_local': 'Оставить локальные',
      'budget_categories': 'Категорії',
      'budget_categories_all': 'Усі',
      'budget_rollover': 'Перенос остатка',
      'budget_rollover_desc': 'Непотраченное переноситься на наступний период',
      'pick_date_range': 'Выбрать период',
      'date_from': 'С',
      'date_to': 'По',
      'export_pdf_date': 'Дата',
      ...
      'export_total_income': 'Всього доходів',
      'export_total_expense': 'Всього витрат',
      'export_net': 'Баланс',
      'tags_label': 'Теги',
      'tags_hint': 'отпуск, робота…',
      'import_duplicates_skipped': 'Пропущено дубликатов: {}',
      'pro_expires': 'Pro до {}',
      'pro_valid_until': 'Действует до {}',
      'pro_expires_loading': 'Завантаження даты продления…',
      'pro_days_left': 'Залишилось {} дн.',
      'pro_manage_subscription': 'Управление підпиской',
      'shared_budget_title': 'Загалий бюджет',
      'shared_budget_subtitle': 'Отслеживайте і синхронизируйте траты с партнером',
      'shared_budget_create': 'Створить парный бюджет',
      'shared_budget_join': 'Присоединиться по коду',
      'shared_budget_join_hint': 'Введіть код приглашения партнера',
      'shared_budget_invite_code': 'Код приглашения',
      'shared_budget_sign_in': 'Войдите, щпро делиться бюджетом',
      'shared_budget_even': 'Вы у рарахуноке ✌️',
      'shared_budget_sync': 'Синхронизировать моі траты за місяц',
      'shared_budget_leave': 'Вийті з загалего бюджета',
      'shared_budget_leave_title': 'Вийті з загалего бюджета?',
      'shared_budget_leave_body': 'Вы перестанете видеть загалие траты.',
      'shared_budget_code_copied': 'Код скопірован',
      'shared_budget_invalid_code': 'Неверный код',
      'shared_budget_full': 'У цьому бюджете вже є партнер',
      'shared_budget_already_joined': 'Вы вже у загалем бюджете',
      'shared_budget_waiting': 'Ждём партнера…',
      'shared_budget_synced': 'Синхронизировано {} трат',
      'shared_budget_partner_owes': 'Партнер должен вам {}',
      'shared_budget_you_owe': 'Вы должны партнеру {}',
      'you_label': 'Вы',
      'pro_gate_shared_budget': 'Загалий бюджет с партнером і синхронизація трат у хмаре.',
      'widget_budget_left': 'Залишилось',
      'widget_month_expense': 'Витрата',
      'smart_budget_title': 'Бюджет',
      'smart_budget_body': '{} почті исчерпан ({})',
      'select_short': 'Выбрать',
      'enter_note_hint': 'Введіть заметку...',
      'backups_short': 'Бэкапы',
      'transfer_between': 'Внутренний переказ',
      'transfer_between_title': 'Переказ між рахункими',
      'transfer_between_short': 'Внутренний переказ',
      'transfer_between_tab': 'Внутренний переказ',
      'transfer_external': 'Внешний переказ',
      'transfer_external_tab': 'Внешний переказ',
      'transfer_between_hint': 'Переказ між своимі рахункими. Це не дохід і не витрат.',
      'transfer_external_hint': 'Гроші уходят вовне. Считаеться витратом.',
      'month_balance': 'Баланс за місяц',
      'month_net': 'Разом',
      'sign_in': 'Увійти',
      'sign_in_apple': 'Продовжиті с Apple',
      'sign_in_google': 'Продовжиті с Google',
      'sign_in_email': 'Email і пароль',
      'register': 'Створить акаунт',
      'sign_out': 'Вийти',
      'signed_in_as': 'Вы вошли',
      'delete_cloud_account': 'Видалиті хмарный акаунт',
      'delete_cloud_account_title': 'Видалиті хмарный акаунт?',
      'delete_cloud_account_body': 'Будут видалены логин (Apple, Google або email), хмарная копія, участие у загалем бюджете і ваші загалие витраты. Такнные на цьому телефоне остануться. Це нельзя скасувить.',
      'delete_cloud_account_relogin': 'Из соображений безпечності войдите ще раз і повторите. Apple і Google требуют недавний вход.',
      'delete_cloud_account_failed': 'Не вдалося видалить акаунт',
      'auth_failed': 'Не вдалося войти',
      'auth_invalid_email': 'Некорректный email',
      'auth_weak_password': 'Пароль слишком короткий',
      'auth_wrong_password': 'Неверный email або пароль',
      'auth_user_disabled': 'Акаунт отключён',
      'auth_too_many': 'Слишком много попыток. Пізніше',
      'auth_canceled': 'Вход скасувён',
      'cloud_backup_ok': 'Копія завантаженоа у хмаро',
      'cloud_restore_ok': 'Такнные відновллены з хмара',
      'cloud_empty': 'У хмаре покі немає копіи',
      'sign_in_to_sync': 'Войдите, щпро синхронизировать',
      'email': 'Email',
      'password': 'Пароль',
      'firebase_not_ready': 'Хмаро увімкним, колі заказчидо даст Firebase.',
      'cloud_backup': 'Хмарная копія',
      'cloud_restore': 'Відновлить з хмара',
      'sync_devices': 'Синхронизація пристро',
      'security': 'Безпека',
      'pin_code': 'PIN-код',
      'pin_code_hint': 'Необов\'язково. Якщо Face ID не спрацює',
      'use_biometrics': 'Біометричний замок',
      'biometric_lock_hint': 'Запитувати Face ID або відбиток при вході',
      'auto_lock': 'Автоблокувовка',
      'auto_lock_hint': 'Блокувовать під час выходе з додаткия',
      'biometrics_unavailable': 'Біометрия на цьому пристрое недоступна',
      'biometrics_failed': 'Не вдалося увімкнить біометрию',
      'enter_pin': 'Введіть PIN',
      'set_pin': 'Створить PIN',
      'confirm_pin': 'Повторите PIN',
      'pin_mismatch': 'PIN не совпадает',
      'pin_wrong': 'Неверный PIN',
      'unlock': 'Розблокувати',
      'unlock_biometric_hint': 'Використай Face ID або відбиток, щоб продовжити',
      'export_csv': 'Експорт CSV',
      'export_excel': 'Експорт Excel',
      'export_pdf': 'Експорт PDF',
      'export_period': 'Період експорта',
      'period_this_month': 'Цей місяць',
      'period_last_month': 'Минулий місяць',
      'period_3m': '3 місяця',
      'period_6m': '6 місяців',
      'period_this_year': 'Цет год',
      'period_last_year': 'Прошлый год',
      'period_custom': 'Свой период',
      'choose_period': 'Выбрать период',
      'restore_local': 'Відновлить',
      'data_restored': 'Такнные відновллены',
      'restore_failed': 'Не вдалося відновлить',
      'import_backup_json': 'Імпорт JSON-копіи',
      'cloud_backup_failed': 'Не вдалося збережить хмарную копію',
      'fx_approximate_balance': 'Курсы недоступны · баланс приблизительный',
      'import_no_accounts': 'Сначала создайте рахунок',
      'import_no_rows': 'У файле не знайдено операций',
      'data_load_db_error': 'Не вдалося прочитать локальную базу',
      'data_load_network_error': 'Помилка сеті під час завантажке даних',
      'data_load_generic_error': 'Не вдалося завантажить дані',
      'firebase_offline_banner': 'Ні связі с Firebase: вход, хмаро і ИИ недоступны',
      'data_init_failed_banner': 'Помилка локальных даних. Перезапорожните додаткие',
      'account_section': 'Акаунт',
      'pro_title': 'Monedero Pro',
      'pro_subtitle': 'Без лімітоу на рахунки, цели, звіты, ИИ (чекі і голос), імпорт і хмарные копіи.',
      'pro_cta_subtitle': 'Доступ без ограничений',
      'pro_go': 'Перейті на Pro',
      'pro_restore': 'Відновлить покупки',
      'pro_sign_in_required': 'Войдите у акаунт, щпро активировать Pro',
      'pro_restore_empty': 'Активных покуподо не знайдено',
      'pro_legal_notice': 'Оплата списываеться с Apple ID. Підписка продлеваеться автоматични, якщо не скасувить её минимум за 24 часа до конца периода. Управление: Налаштування → Apple ID → Підписки. Покупка во время пробного периода скасувяет оставшиеся дні триала. Продовжая, вы принимаете Умові использования і Политику конфіденційности.',
      'pro_yearly': 'На год',
      'pro_monthly': 'На місяц',
      'pro_semi_annual': '6 місяців',
      'pro_yearly_save': '−44%',
      'pro_trial': '7 дней безкоштовно',
      'pro_active': 'Monedero Pro активен',
      'pro_active_short': 'Активен',
      'pro_buy_failed': 'Не вдалося завершить покупку',
      'pro_store_empty': 'Цены зараз недоступны. Проверьте інтернемає і спробуйте знову.',
      'pro_debug_unlock': 'Відкрить Pro (debug)',
      'import_csv': 'Імпорт CSV',
      'import_csv_hint': 'Імпортируйте CSV Monedero або банковскую выписку с датой і сумой.',
      'import_pick_file': 'Выбрать файл',
      'import_preview': '{n} операций готово · {s} стродо пропущено',
      'import_confirm': 'Імпортировать',
      'import_failed': 'Не вдалося імпортировать файл',
      'import_done': 'Імпортировано {} операций',
      'reminders_page_hint': 'Настрой, колі напоминать о витратах. Умные сповіщения — лише у Pro.',
      'daily_reminder_section': 'Ежедневное нагадувание',
      'smart_reminders': 'Умные нагадувания',
      'smart_reminders_hint': 'Платежи, підпискі і цели',
      'smart_reminders_desc': 'Напомним у день борга, за день до списания підпискі і по цілім с бюджетами.',
      'smart_debt_title': 'Платёж',
      'smart_debt_body': 'Сьогодні сродо платежа: {}',
      'smart_sub_title': 'Підписка',
      'smart_sub_body': 'Скоро спишеться {}',
      'smart_goal_title': 'Ціль',
      'smart_goal_body': 'Проверьте ціль: {}',
      'pro_gate_accounts': 'Доступно до 3 рахункіу у безкоштовной версіи.\nПерейдите на Pro, щпро додавить неограниченное количество рахунків.',
      'pro_gate_goals': 'Доступно до 2 активных цілей у безкоштовной версіи.\nПерейдите на Pro, щпро створить неограниченное количество цілей.',
      'pro_gate_budgets': 'Доступно до 3 активных бюджетоу у безкоштовной версіи.\nПерейдите на Pro, щпро створить неограниченное количество бюджетов.',
      'pro_gate_debts': 'Доступно до 2 активных боргоу у безкоштовной версіи.\nПерейдите на Pro, щпро додавить неограниченное количество боргов.',
      'pro_gate_subscriptions': 'Доступно до 3 активных подписодо у безкоштовной версіи.\nПерейдите на Pro, щпро додавить неограниченное количество подписок.',
      'pro_gate_recurring': 'Доступно до 3 регулярных операций у безкоштовной версіи.\nПерейдите на Pro, щпро додавить неограниченное количество регулярных операций.',
      'pro_gate_analytics': 'Расширенная аналитика доступна у Pro.\nПерейдите на Pro, щпро анализировать своі фінансы за 3, 6 і 12 місяців.',
      'pro_gate_trends': 'Расширенный аналз тенденций доступен у Pro.\nПерейдите на Pro, щпро отслеживать змінения дохідоу і витратов.',
      'pro_gate_flows': 'Расширенный аналз денежных потікоу доступен у Pro.\nПерейдите на Pro, щпро докладно анализировать движение ваших грошей.',
      'pro_gate_currencies': 'У безкоштовной версіі доступна 1 основная валюта.\nПерейдите на Pro, щпро использовать несколько валют і рахункі у разных валютах.',
      'pro_gate_cloud': 'Хмарные копіі доступны у Pro.\nЗбережяйте своі фінансовые дані у хмаре і восстанавливайте их на любом пристрое.',
      'pro_gate_sync': 'Синхронизація між пристроамі доступна у Pro.\nПерейдите на Pro, щпро синхронизировать своі фінансовые дані між пристроами.',
      'pro_gate_excel': 'Експорт у Excel доступен у Pro.\nПерейдите на Pro, щпро експортировать своі фінансовые дані у Excel.',
      'pro_gate_pdf': 'Експорт у PDF доступен у Pro.\nПерейдите на Pro, щпро создавать PDF-звіты о своих фінансах.',
      'pro_gate_reminders': 'Нагадувания доступны у Pro.\nПерейдите на Pro, щпро отриманать нагадувания о платежах, підписках і фінансовых ціліх.',
      'pro_gate_import': 'Імпорт CSV і выписодо доступен у Pro.\nПерейдите на Pro, щпро імпортировать операції.',
      'pro_gate_ai': 'AI-асистент (голос, чеки, чат) доступен у Pro.\nВойдите у акаунт і перейдите на Pro.',
      'ai_recognize_receipt': 'Розпізнать с ИИ',
      'ai_voice_entry': 'Записать голосом',
      'ai_voice_empty_title': 'Покі немає операций',
      'ai_voice_empty_hint': 'AI-асистент — скажі операцію, я збережю.',
      'ai_voice_hint': 'Скажи: витратил 10 на таксі і 20 на еду',
      'ai_voice_confirm_title': 'Подтверждение',
      'ai_voice_confirm_count': '{} транзакціи',
      'ai_voice_approve': 'Одобрить',
      'ai_voice_saved': 'Збережено операций: {}',
      'ai_listening': 'Слухаю…',
      'ai_confirm_transcript': 'Использовать цей текст?',
      'ai_use_transcript': 'Использовать',
      'ai_category_suggest': 'ИИ предлагает: {}',
      'ai_apply_category': 'Применить',
      'ai_insight_title': 'ИИ-инсайт',
      'ai_insight_generate': 'Сгенерировать',
      'ai_insight_hint': 'Краткий текст по итогам периода. Сырые операциі не надсилляються.',
      'ai_chat_title': 'Асистент',
      'ai_chat_hint': 'Голос, фото або текст — запишу витраты і дохіды.',
      'ai_chat_placeholder': 'Повідомлення…',
      'ai_chat_welcome': 'Привет! Я твой фінансовый асистент. Могу записать витрат або дохід — напиші «Кофе 60» або «Зарплата 25000». Можно надсаботь фото чека, сказать голосом або спросить про дані у додаткии.',
      'ai_assistant_eyebrow': 'AI',
      'ai_recording': 'Записую…',
      'ai_chat_receipt_sent': '📷 Чек',
      'ai_receipt_unreadable': 'Не вдалося прочитать чек. Спробуй другое фото або напиші операцію текстом.',
      'ai_assistant_recorded': 'Записано {} операций на {}',
      'ai_assistant_receipt_saved': 'Витрата по чеку записан: {}',
      'ai_busy': 'Думаю…',
      'ai_failed': 'Не вдалося выполнить запрос до ИИ. Спробуйте ще раз.',
      'ai_blocked': 'ІИ заблокував відповідь. Переформулюйте повідомлення.',
      'ai_empty_response': 'ІИ повернув порожню відповідь. Спробуйте ще раз.',
      'ai_invalid_response': 'ІИ повернув неочікуваний формат. Спробуйте ще раз.',
      'ai_speech_unavailable': 'Микрофон недоступен. Введіть витрат текстом або спробуйте на реальном iPhone.',
      'ai_api_not_enabled': 'Увімкните Gemini / Firebase AI Logic у консолі Firebase.',
      'ai_permission_denied': 'Firebase відхабол ИИ (App Check). У debug: скопіруйте токен з логоу і збережите у Firebase → App Check → Manage debug tokens.',
      'ai_quota_exceeded': 'Ліміт ИИ исчерпан. Спробуйте пізніше.',
      'ai_filled': 'Поля заповнены за допомогою ИИ',
      'ai_energy_empty': 'Енергія закончилась. Перейдите на Premium для безлімітного асистента.',
    },
  };
}
